...
import com.example.nctai_trading.binanceUS.InterfaceModel.*;
import com.example.nctai_trading.binanceUS.Controller.MarketAPI.*;
import com.example.nctai_trading.binanceUS.Controller.AccountAPI.*;
import com.example.nctai_trading.binanceUS.Controller.AccountAPI.OpenOCO.*;
import com.example.nctai_trading.binanceUS.Controller.AccountAPI.OCO.*;
import com.example.nctai_trading.binanceUS.Controller.AccountAPI.AccountInfo.*;


import com.example.nctai_trading.binanceUS.Client.*;

import com.example.nctai_trading.binanceUS.ClientModel.*;

import com.example.nctai_trading.binanceUS.Controller.*;
...
public class BinanceRestAPI {
    ...
    public boolean testConnectivity(BinanceClient client) throws IOException {
        ...
        generalInterface generalInterface = retrofit.create(com.example.nctai_trading.binanceUS.InterfaceModel.generalInterface.class);
    ...
    public Long getServerTime(BinanceClient client) throws IOException {
        ...
        Call<com.example.nctai_trading.binanceUS.Controller.GeneralEndpointAPI.ServerTime> call = generalInterface.getServerTime();
    ...
    public com.example.nctai_trading.binanceUS.Controller.MarketAPI.OrderBook getOrderBook(BinanceClient client) throws IOException {
        ...
        marketInterface marketInterface = retrofit.create(com.example.nctai_trading.binanceUS.InterfaceModel.marketInterface.class);

        Call<com.example.nctai_trading.binanceUS.Controller.MarketAPI.OrderBook> call = marketInterface.getOrderBook(client.getMarket().generateQueries());

        Response<com.example.nctai_trading.binanceUS.Controller.MarketAPI.OrderBook> response = call.execute();
    ...
    public NewOrder placeNewOrder(BinanceClient client) throws IOException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        accountInterface accountInterface = retrofit.create(com.example.nctai_trading.binanceUS.InterfaceModel.accountInterface.class);
