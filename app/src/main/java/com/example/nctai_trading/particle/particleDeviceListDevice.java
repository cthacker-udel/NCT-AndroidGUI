...
public class particleDeviceListDevice {
    ...
    @Expose
    private particleDeviceListVariables variables;
    ...
    public particleDeviceListVariables getVariables() {
        return variables;
    }

    public void setVariables(particleDeviceListVariables variables) {
