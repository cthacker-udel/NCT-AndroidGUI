...
public class AnyJSON {
     ...
     */
    public AnyJSON(final Object any, boolean structureOnly) throws JSONException {
     ...
     */
    public static AnyJSON readFile(File f) throws IOException, JSONException {
        try (FileInputStream fis = new FileInputStream(f)) {
            return new AnyJSON(new JSONTokener(fis.toString()));
     ...
     * @param any Object to make JSON.
     */
    public AnyJSON(final Object any) throws JSONException {
        this.any = JSONObject.wrap(any);
        if (this.any == null) {
            return;
        }
     ...
     */
    public AnyJSON(final String source) throws JSONException {
     ...
     */
    public AnyJSON(final JSONTokener toker) throws JSONException {
        char c = toker.next();
        toker.back();
        if (c == '[') {
