...
public class bitbyOrderResponse {
    ...
    @Expose
    private bitbyOrderResponseResult result;
    ...
    public bitbyOrderResponseResult getResult() {
        return result;
    }

    public void setResult(bitbyOrderResponseResult result) {
        this.result = result;
    }
